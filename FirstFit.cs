...
{
    internal class FirstFit : Scheduler, Algorithm
    {
        /// <summary>
        ...
        public FirstFit(int totalMemory, int OSMemory)
        ...
        /// <summary>
        /// FITS PROCESSES INTO MEMORY ACCORDING TO THE FIRSTFIT SCHEME
        /// </summary>
        ...
        public override List<string> FitProcess(Process processToAdd)
        {
            ...
            for (int i = 0; i < temp.Length; i++)
            {
                ...
                {
                    if (gapSize >= processToAdd.size)
                    {
                        largestGap = gapSize;
                        gapStart = i - gapSize + 1;
                        break;
                    }
                    else
                    {
